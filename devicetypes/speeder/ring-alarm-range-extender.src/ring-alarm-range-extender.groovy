...
metadata {
  definition(
    name: "Ring Alarm Range Extender", namespace: "speeder", author: "Speeder2000",
      importUrl: "https://raw.githubusercontent.com/Speeder2000/SmartThings-Speeder2000/master/devicetypes/speeder/ring-alarm-range-extender.src/ring-alarm-range-extender.groovy") {
    capability "Sensor"
    capability "Battery"
...
def zwaveEvent(physicalgraph.zwave.commands.batteryv1.BatteryReport cmd) {
  logDebug "zwaveEvent(physicalgraph.zwave.commands.batteryv1.BatteryReport cmd)"
...
def zwaveEvent(physicalgraph.zwave.commands.versionv1.VersionReport cmd) {
  logDebug "zwaveEvent(physicalgraph.zwave.commands.versionv1.VersionReport cmd)"
  logTrace "cmd: $cmd"
...
def zwaveEvent(physicalgraph.zwave.commands.manufacturerspecificv2.ManufacturerSpecificReport cmd) {
  logDebug "zwaveEvent(physicalgraph.zwave.commands.manufacturerspecificv2.ManufacturerSpecificReport cmd)"
  logTrace "cmd: $cmd"
...
def zwaveEvent(physicalgraph.zwave.commands.notificationv3.NotificationReport cmd) {
  logDebug "zwaveEvent(physicalgraph.zwave.commands.notificationv3.NotificationReport cmd)"
...
def zwaveEvent(physicalgraph.zwave.commands.configurationv1.ConfigurationReport cmd) {
  logDebug "zwaveEvent(physicalgraph.zwave.commands.configurationv1.ConfigurationReport cmd)"
  logTrace "cmd: $cmd"
...
def zwaveEvent(physicalgraph.zwave.Command cmd) {
  logDebug "zwaveEvent(physicalgraph.zwave.Command cmd)"
